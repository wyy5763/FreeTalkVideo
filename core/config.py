...
class Settings:
    ...
    tts_mode: str = os.getenv("TTS_MODE", "api").lower()
    ...
    cosyvoice_fp16: bool = _bool("COSYVOICE_FP16", True)
    ...
    musetalk_gpu_id: int = int(os.getenv("MUSETALK_GPU_ID", "0"))
    musetalk_batch_size: int = int(os.getenv("MUSETALK_BATCH_SIZE", "8"))
    musetalk_float16: bool = _bool("MUSETALK_FLOAT16", True)
